...
![Add a date range field to a report date parameter](/attachments/refguide/modeling/pages/report-widgets/report-date-parameter/date-range-field/add-field.png)
