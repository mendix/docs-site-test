...
* <a name="875726"></a>We applied an important security patch that fixed the [SSA-875726 Privilege Escalation Vulnerability](https://new.siemens.com/global/en/products/services/cert.html#SecurityPublications) for authenticated users. We strongly advise upgrading your Mendix applications to this version (or to [8.12.5](8.12#8125) or [8.18](8.18), where the issue has also been fixed).
...
* <a name="private-content"></a>Downloading private content in the Marketplace available in Studio Pro has been enabled again for this version and all further 8.6.x versions. It is not possible for Studio Pro versions below 8.6.4. This has also been fixed for [Studio Pro 8.10.0](8.10#211).
...
* <a name="93385"></a>We fixed an issue that was introduced in version [8.5.0](8.5#850) where the changes in a microflow [change object](/refguide8/change-object) activity were not executed sequentially. (Ticket 93385)
