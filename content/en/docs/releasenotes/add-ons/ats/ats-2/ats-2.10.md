...
* Test case executions in Browserstack now show the result from ATS.
  ...
  ![Browserstack-ATS integration](/attachments/releasenotes/add-ons/ats/browserstack.png)
...
![Browserstack-ATS integration](/attachments/releasenotes/add-ons/ats/lookup.gif)
