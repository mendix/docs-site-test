...
![](/attachments/studio8/publishing-app/preview.jpg)
...
![Preview Modes](/attachments/studio8/publishing-app/preview-modes.jpg)

To exit the preview environment, click **Close Preview** in the top-right corner of the screen.

![Close Preview](/attachments/studio8/publishing-app/close-preview.jpg)
...
2.  In the **Publish your app** pop-up message, click the **Publish** button to push the latest changes from Studio to the published app or to publish the app for the first time. 
    ...
    ![Publishing and Updating Your App](/attachments/studio8/publishing-app/publish-button.jpg)
...
3. Click the link under **View the published app here**:
    ...
    ![View in Browser](/attachments/studio8/publishing-app/view-in-browser.jpg)
...
2. In the **Publish your app** pop-up message, click **View current app**:
    ...
    ![View Current App](/attachments/studio8/publishing-app/view-current-app.jpg)

3. Scan the QR code to view your app on your mobile device: 

    ![View on Mobile Device Option](/attachments/studio8/publishing-app/view-on-mobile.jpg)
