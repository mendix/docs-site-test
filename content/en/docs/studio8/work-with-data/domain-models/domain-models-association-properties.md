...
*  An icon next to the entity that has such association: 
   ...
   ![](/attachments/studio8/work-with-data/domain-models/domain-models-association-properties/association-icon.png)

*  A pop-up window, which displays when you click the icon:

   ![](/attachments/studio8/work-with-data/domain-models/domain-models-association-properties/association-pop-up.png)
