...
![](/attachments/howto8/extensibility/get-started-with-the-timeseries-connector/Systemoverview.PNG)
...
![](/attachments/howto8/extensibility/get-started-with-the-timeseries-connector/Domainmodel.png)
...
1. Provide an **Asset name**, otherwise the connector will return an error. You are free to choose the name.
  ...
  ![](/attachments/howto8/extensibility/get-started-with-the-timeseries-connector/CreateAsset.png)
...
![](/attachments/howto8/extensibility/get-started-with-the-timeseries-connector/create-asset-microflow.png)
...
![](/attachments/howto8/extensibility/get-started-with-the-timeseries-connector/CreateChannel.png)
...
![](/attachments/howto8/extensibility/get-started-with-the-timeseries-connector/create-channel-microflow.png)
...
![](/attachments/howto8/extensibility/get-started-with-the-timeseries-connector/StoreMeasurement.png)
...
![](/attachments/howto8/extensibility/get-started-with-the-timeseries-connector/store-measurement-microflow.png)
...
1. Create an **AggregateSearchResult** object to use as the **Type parameter**. If you create a new entity, make sure it has all the necessary attributes as defined in this example:
  ...
  ![](/attachments/howto8/extensibility/get-started-with-the-timeseries-connector/example-aggregate-domain.png)
...
![](/attachments/howto8/extensibility/get-started-with-the-timeseries-connector/AggregateSearch.png)
...
![](/attachments/howto8/extensibility/get-started-with-the-timeseries-connector/get-aggregations-microflow.png)
