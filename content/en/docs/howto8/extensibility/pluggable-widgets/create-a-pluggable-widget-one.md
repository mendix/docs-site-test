...
6. Open the Textbox's properties and select the **Datasource Attribute (path)** string attribute you created above. Then click the **OK** button to close the dialog box. The end result should look like this:
	...
	![](/attachments/howto8/extensibility/pluggable-widgets/create-a-pluggable-widget-one/createtestobject.png)

	![](/attachments/howto8/extensibility/pluggable-widgets/create-a-pluggable-widget-one/microflowcreateentity.png)
...
![mx generator](/attachments/howto8/extensibility/pluggable-widgets/create-a-pluggable-widget-one/generatorblack.png)
...
8.  When running the project, the new widget is already functional. The first text box is a standard Text box widget and the second is your pluggable web widget. When data is changed in the first input and the cursor is moved to the next widget, the data of your widget is also updated: 
	...
	![two text widgets](/attachments/howto8/extensibility/pluggable-widgets/create-a-pluggable-widget-one/twotextwidgets.png)
...
3. Your efforts will result in a well-styled input widget:
	...
	![styled widgets](/attachments/howto8/extensibility/pluggable-widgets/create-a-pluggable-widget-one/styledinputwidgets.png)
...
1. In the *TextBox.xml* file, add an element `<propertyGroup caption="Label">` with a child element `<systemProperty />` above the existing `<propertyGroup caption="Data source">` element:
	...
	![edit text box two](/attachments/howto8/extensibility/pluggable-widgets/create-a-pluggable-widget-one/edittextboxtwo.png)

2. Preview the label in the page editor:

	![edit data view one](/attachments/howto8/extensibility/pluggable-widgets/create-a-pluggable-widget-one/editdataviewone.png)
...
3. This will result in a label above or next to the input depending on the available space, data view `Form orientation`, and the `Label width (weight)`:
	...
	![input widgets with label](/attachments/howto8/extensibility/pluggable-widgets/create-a-pluggable-widget-one/inputwidgetswithlabel.png)
