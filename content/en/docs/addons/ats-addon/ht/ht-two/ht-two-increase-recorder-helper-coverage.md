...
5.  Enter a name in the dialog and click **OK**. This opens the **Constant** dialog. where you can add the following properties:
	...
	* Default value: True
	...
	![](/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-coverage/add-constant.png)
...
![](/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-coverage/changed-mx-name.png)
...
![](/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-coverage/not-recordable-image.png)
...
![](/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-coverage/2-mx-names.png)
...
![](/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-coverage/no-mx-name-listview.png)
...
![](/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-coverage/no-mx-name-listview-app-e.png)

You can manually enter a class in the **Class** of Mendix Studio Pro with an mx-name to solve this:

![](/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-coverage/mx-name-listview.png)

![](/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-coverage/mx-name-listview-app-e.png)
...
![](/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-coverage/extra-class-name.png)
...
![](/attachments/addons/ats-addon/ht/ht-two/ht-two-increase-recorder-coverage/mx-name-in-name.png)
