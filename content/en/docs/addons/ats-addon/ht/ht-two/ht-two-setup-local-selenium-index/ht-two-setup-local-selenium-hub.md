...
3.  Check with the following link if the hub works: `http://localhost:4444/grid/console`.
	...
	![](/attachments/addons/ats-addon/ht/ht-two/ht-two-setup-local-selenium-index/ht-two-setup-loc-sel-ix/ht-two-setup-local-selenium-hub/grid_hub.png)
...
3.  Check in the console whether your Selenium hub node is active `http://localhost:4444/grid/console`:
	...
	![](/attachments/addons/ats-addon/ht/ht-two/ht-two-setup-local-selenium-index/ht-two-setup-loc-sel-ix/ht-two-setup-local-selenium-hub/grid_nodes.png)
