...
1.  Add a Custom Capability to your Selenium hub configuration: **enableVideo** with a Boolean set to **true**
	...
	![](/attachments/addons/ats-addon/ht/ht-two/ht-two-setup-local-selenium-index/ht-two-setup-loc-sel-ix/ht-two-setup-local-selenoid-hub/add_capability.png)
...
3.  (Optional:) You can give the video file a custom name by adding another Custom Capability: **VideoName** with a string, for example **MyTestVideo.mp4** (don't forget the .mp4!)
	...
	![](/attachments/addons/ats-addon/ht/ht-two/ht-two-setup-local-selenium-index/ht-two-setup-loc-sel-ix/ht-two-setup-local-selenoid-hub/video_name.png)
...
6.  To enable "Live-View" you need to add another Custom Capability to your Selenium hub configuration: **enableVNC** with Boolean set to **true**
	...
	![](/attachments/addons/ats-addon/ht/ht-two/ht-two-setup-local-selenium-index/ht-two-setup-loc-sel-ix/ht-two-setup-local-selenoid-hub/enable_vnc.png)

7.  After starting your test case you can view your session in the portal:

	![](/attachments/addons/ats-addon/ht/ht-two/ht-two-setup-local-selenium-index/ht-two-setup-loc-sel-ix/ht-two-setup-local-selenoid-hub/selenoidui1.png)

8.  By clicking on your session, you will be able to see your live view:

	![](/attachments/addons/ats-addon/ht/ht-two/ht-two-setup-local-selenium-index/ht-two-setup-loc-sel-ix/ht-two-setup-local-selenoid-hub/selenoidui2.png)
