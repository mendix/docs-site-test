...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-statistics-tool/Trend.png)
...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-statistics-tool/Manual_statistics.png)  
...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-statistics-tool/Now_Running.png)
...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-statistics-tool/Snapshots.png)
...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-statistics-tool/Snapshot_Details.png)
...
This screenshot shows the options of the statistics tool:
 ...
 ![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-statistics-tool/Options.png)
...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-statistics-tool/Protections.png)
