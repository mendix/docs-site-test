...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-dashboard/Configuration_After_Startup.png)
...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-dashboard/Configuration_License.png)
...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-dashboard/Configuration_JDBC.png)                       
...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-dashboard/Configuration_CleanData.png)                       

## 6 More {#more}

Some other features and settings are collected on the **More** tab:

![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-dashboard/Configuration_More.png)                       
...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-dashboard/StartStop.png)                       
