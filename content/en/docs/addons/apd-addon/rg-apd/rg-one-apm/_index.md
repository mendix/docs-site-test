...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-introduction/Performance_Tool_Tree_View.png)
...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-introduction/Performance_Tool_Browse_Microflow.png)

This is the SQL statements during an action:

![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-introduction/Performance_Tool_Browse_Actions.png)
...
![](/attachments/addons/apd-addon/rg-apd/rg-one-apm/rg-one-introduction/Measurements_Tool.png)
