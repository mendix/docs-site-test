...
![](/attachments/addons/apd-addon/rg-apd/rg-three-apd/rg-three-recorder/rg-three/select-browsers.png)

When recording a browser, the user has to confirm the following message:

![](/attachments/addons/apd-addon/rg-apd/rg-three-apd/rg-three-recorder/rg-three/Browser_agent_recording_notice.png)
...
![](/attachments/addons/apd-addon/rg-apd/rg-three-apd/rg-three-recorder/rg-three/recorder.png)
