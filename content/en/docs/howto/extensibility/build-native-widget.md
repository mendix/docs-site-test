...
![final widget](/attachments/howto/extensibility/build-native-widget/group-box-tease.png)
...
4. The generator will ask you for some input during setup. Provide this information to the generator:
	...
	* Unit tests: {**No**}
	...
	![Pluggable Widget Generator input](/attachments/howto/extensibility/build-native-widget/pluggable-widget-generator-input.png)
...
5.  Copy the **Home** container and paste it underneath that container:
	...
	![home container](/attachments/howto/extensibility/build-native-widget/home-container.png)
...
8. Drag and drop the widget into your empty container:
	...
	![initial widget](/attachments/howto/extensibility/build-native-widget/initial-widget.png)
...
3.  Verify that your app's home page contains the yellow text **Hello {your name}**.
	...
	![hello user](/attachments/howto/extensibility/build-native-widget/1-yellow-text-mobile.png)
...
8. Verify with the Make It Native app that your app looks like the image below:
	...
	![basic app](/attachments/howto/extensibility/build-native-widget/2-header-caption-mobile.png)
...
5. Verify that the group box widget looks like the image below:
	...
	![black white widget](/attachments/howto/extensibility/build-native-widget/3-bw-header.png)
...
4. Fill in some caption text, click **OK**, and rerun your app locally to see your caption text in the app:
	...
	![sample text pro](/attachments/howto/extensibility/build-native-widget/sample-caption-pro.png)

	![sample text mobile](/attachments/howto/extensibility/build-native-widget/4-this-is-my-text.png)
...
3. Update the group box widget again. A content area will appear in the page editor:
	...
	![content area](/attachments/howto/extensibility/build-native-widget/content-area.png)
...
11. With the Make It Native app, verify that your button is inside the group box and is triggering a message popup saying **Hello World!**.
	...
	![hello world](/attachments/howto/extensibility/build-native-widget/5-hello-world.png)
...
4. To see your changes, drag and drop a new **Group box** widget onto your home page. Run your app and check to see that your new group box with no content shows no empty white box:
	...
	![new group box](/attachments/howto/extensibility/build-native-widget/6-button-inside.png)
...
11. Click the € sign and click **Select**:
	...
	![euro](/attachments/howto/extensibility/build-native-widget/euro-icon.png)
...
5. Refresh the app in the Make It Native app. You should see the white icons in the correct size:
	...
	![better button](/attachments/howto/extensibility/build-native-widget/7-better-button-inside.png)
	
	![collapsed with euro](/attachments/howto/extensibility/build-native-widget/8-collapsed-w-euro-sign.png)
...
4. Add this image as a widget icon by following the substeps below:
	...
	![Group box icon](/attachments/howto/extensibility/build-native-widget/group-box.png)
...
5. Update the group box widget. Notice that now your widget has the icon you loaded into its *xml*:
	...
	![groupbox 64](/attachments/howto/extensibility/build-native-widget/groupbox-64-icon.png)
...
6. Verify that the collapsible property options behave correctly by double-clicking your widget and testing each collapsible property option on your test device:
	...
	![collapsible properties](/attachments/howto/extensibility/build-native-widget/collapsible-properties.png)
...
3. Save the file and refresh the your app in the Make It Native app to see your new default style. On Android, note the ripple effect on the header that was previously not visible:
	...
	![default styling](/attachments/howto/extensibility/build-native-widget/9-default-styling.png)
...
5. Click **OK** and rerun the app locally to see the warning style:
	...
	![warning styling](/attachments/howto/extensibility/build-native-widget/10-warning-styling.png)
...
6. Select the **Success** style and click **OK**:
	...
	![success style](/attachments/howto/extensibility/build-native-widget/success-design-property.png)
