...
1.  Place a button widget on your app's home page:
	...
	![button](/attachments/howto/mobile/native-mobile/implementation/native-styling/how-to-use-native-styling/button-one.png)
...
4.  Type *btnSuccess* into the **Class** field:
	...
	![class field](/attachments/howto/mobile/native-mobile/implementation/native-styling/how-to-use-native-styling/btn-success.png)

5.  Click the play button (**Run Locally**) to save and refresh your app. Notice the button turned green:

	![green button](/attachments/howto/mobile/native-mobile/implementation/native-styling/how-to-use-native-styling/green-button.png)
...
3.  Click the **Button style** drop-down arrow and select **Warning**.
	...
	![warning button](/attachments/howto/mobile/native-mobile/implementation/native-styling/how-to-use-native-styling/btn-warning.png)

4.  Run your app again to see the *design* button's new color:

	![orange button](/attachments/howto/mobile/native-mobile/implementation/native-styling/how-to-use-native-styling/orange-button.png)
...
10.  Click the play button (**Run Locally**) to see that your button's background color is transparent:
	...
	![bordered button](/attachments/howto/mobile/native-mobile/implementation/native-styling/how-to-use-native-styling/bordered-button.png)
...
5.  Select the fifth button. In **Properties** > **Design Properties**, your **Bordered** design property should now be visible:
	...
	![bordered design property](/attachments/howto/mobile/native-mobile/implementation/native-styling/how-to-use-native-styling/bordered-design-property.png)
...
7.  Click the play button (**Run Locally**) again and view your app:
	...
	![design properties border](/attachments/howto/mobile/native-mobile/implementation/native-styling/how-to-use-native-styling/design-property-border-button.png)
