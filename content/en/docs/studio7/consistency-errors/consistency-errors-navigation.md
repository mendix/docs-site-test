...
![Scheme Showing the Menu Item Error](/attachments/studio7/consistency-errors/consistency-errors-navigation/page-expects-an-object-error.png)
...
2. Open properties of the **Program** menu item, and do the following:<br />
    ...
    {{/* % image_container width="350" % */}}![Menu Item Properties](/attachments/studio7/consistency-errors/consistency-errors-navigation/menu-item-properties.png)
    {{/* % /image_container % */}}
...
![Navigation Item Properties](/attachments/studio7/consistency-errors/consistency-errors-navigation/navigation-item-properties.png)
...
2.  Change the **On Click Action** from **Page** to **Microflow**. 
    ...
    {{/* % image_container width="350" % */}}![Menu Item Properties](/attachments/studio7/consistency-errors/consistency-errors-navigation/menu-item-on-click-action.png)
    {{/* % /image_container % */}}
...
6.  Open the **Create object** activity properties, and set **Entity** to **Customer**.
    ...
    {{/* % image_container width="350" % */}}![Create Object Activity Properties](/attachments/studio7/consistency-errors/consistency-errors-navigation/create-object-properties.png)
    {{/* % /image_container % */}}
...
8.  Open the **Show Page** activity properties and do the following:<br />
    ...
    {{/* % image_container width="350" % */}}![Show Page Properties](/attachments/studio7/consistency-errors/consistency-errors-navigation/show-page-properties.png)
    {{/* % /image_container % */}}

Now the new object of type *Customer* will be created and passed to the home page.

![Open Home Page Microflow](/attachments/studio7/consistency-errors/consistency-errors-navigation/open-page-microflow.png)
