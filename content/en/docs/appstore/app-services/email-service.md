...
*  **Optional Fields**
  ...
  *  **Body** – Defines the body of the email
   ...
   {{% alert color="info" %}}If you want to send an HTML message, you can generate HTML content, and add the generated HTML string in the **Body** field. For more information, see [Generating HTML Body Content](#generate-html-body).{{% /alert %}}
