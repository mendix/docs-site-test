...
![](/attachments/appstore/connectors/database/database-connector-in-toolbox.png)
...
![](/attachments/appstore/connectors/database/callable-statement-action.png)

The `DatabaseConnector.Statement` type is a non-persistable entity defined as follows:

![](/attachments/appstore/connectors/database/statement-parameter-diagram.png)
...
![](/attachments/appstore/connectors/database/primitive-types-parameters.png)
...
![](/attachments/appstore/connectors/database/parameter-object-parameter.png)
...
![](/attachments/appstore/connectors/database/parameter-list-parameter.png)
...
![](/attachments/appstore/connectors/database/parameter-ref-cursor-parameter.png)
