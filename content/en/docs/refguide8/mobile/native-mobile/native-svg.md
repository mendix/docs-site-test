...
![before](/attachments/refguide8/mobile/native-mobile/native-svg/before.png)

Here is how an SVG with the `fill` property looks:

![after](/attachments/refguide8/mobile/native-mobile/native-svg/after.png)
...
![blue svg](/attachments/refguide8/mobile/native-mobile/native-svg/blue-svg.png)
